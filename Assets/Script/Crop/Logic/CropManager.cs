...
namespace MFarm.CropPlant
{
    public class CropManager : Singleton<CropManager>
    {
        ...
        {
            //成长阶段
            int growthStages = cropDetails.growthDays.Length;//获得一共有几个成长阶段
            int currentStage = 0;
            int dayCounter = cropDetails.TotalGrowthDays;//获得种子总共成长了多少天制作一个计时器
            //倒叙计算当前的成长阶段
            ...
            Vector3 pos = new Vector3(tileDetails.gridX + 0.5f, tileDetails.gridY + 0.5f, 0);//调整一下图片,使种子图片放置在格子的最中间
            //生成
